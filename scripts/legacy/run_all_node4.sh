#!/usr/bin/env bash
# run_all_node4.sh — Lanza todos los experimentos en el Nodo 4 (KAU-BCMD / Arabia Saudita).
#
# Ejecutar en la MÁQUINA DEL NODO 4.
#
...
#   IMAGE_ROOT_HOST — ruta al directorio de imágenes KAU-BCMD en este host
#
# Uso:
#   export SERVER_ADDRESS=192.168.1.10:8080
#   export IMAGE_ROOT_HOST=/ruta/local/a/las/imágenes
#   bash scripts/run_all_node4.sh
...
NODE_ID=4 \
MANIFEST_HOST="$REPO_DIR/manifests/node4_manifest.csv" \
