...
class TestDataConfig:
    def test_valid_fractions(self):
        from fedmammo.configs.data_config import DataConfig
...
class TestPartitioningConfig:
    def test_valid_config(self):
        from fedmammo.configs.data_config import PartitioningConfig
...
class TestExperimentConfigValidate:
    def test_full_valid_config_no_raise(self):
        from fedmammo.configs.experiment import ExperimentConfig
    ...
    def test_channel_preset_mismatch_raises(self):
        from fedmammo.configs.experiment import ExperimentConfig
        from fedmammo.configs.model_config import ModelConfig
        from fedmammo.configs.training_config import TrainingConfig, AugmentationConfig
        cfg = ExperimentConfig()
...
class TestC1PatientSplitNoLeakage:
    ...
    def test_no_patient_overlap_train_val(self, tmp_path):
        ...
        from fedmammo.datasets.base import Sample
