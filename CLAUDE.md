...
**Five config generators live in `scripts/`; none of their output should be hand-edited.**
...
template (itself derived from `exp36`). Not yet executed as of 2026-08-19 — no `runs/exp3{7,8,9}...` /
`runs/exp4{0,1}...`.
